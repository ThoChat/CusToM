function [OsteoArticularModel]= LowerTrunk_NoLimits(OsteoArticularModel,k,Mass,AttachmentPoint)
...
% For devMaster :
% MassL1 = 5.7/100*(Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.UpperTrunk_Mass);
% MassL2 = 5.7/100*(Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.UpperTrunk_Mass);
% MassL3 = 5.7/100*(Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.UpperTrunk_Mass);
% MassL4 = 6.2/100*(Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.UpperTrunk_Mass);
% MassL5 = 6.3/100*(Mass.Pelvis_Mass+Mass.LowerTrunk_Mass+Mass.UpperTrunk_Mass);
...
centroide_L5CT = M*k_new*[-2.94559996 -87.24519983 701.76905394]'*0.001;%Repère CT-Scan
CoM_L5CT = centroide_L5CT + M*[-0.1 -0.4 0]'*L5_length; %Repère CT-Scan
CoM_L5 = CoM_L5CT - L5_SacrumJointNodeCT; %Repère segment parent
L5_L4JointNode = L5_L4CT - L5_SacrumJointNodeCT;%Repère segment parent
%L4
centroide_L4CT = M*k_new*[-2.39614997 -104.44660112 722.390606995]'*0.001;%Repère CT-Scan
CoM_L4CT = centroide_L4CT + M*[-0.2 -1.1 0]'*L4_length; %Repère CT-Scan
CoM_L4 = CoM_L4CT - L5_L4CT;%Repère segment parent
L4_L3JointNode = L4_L3CT - L5_L4CT; %Repère segment parent
%L3
centroide_L3CT = M*k_new*[-1.429514095 -112.921062365 755.62319028]'*0.001;%Repère CT-Scan
CoM_L3CT = centroide_L3CT + M*[-0.1 -1.8 0]'*L3_length; %Repère CT-Scan
CoM_L3 = CoM_L3CT - L4_L3CT;%Repère segment parent
L3_L2JointNode = L3_L2CT - L4_L3CT; %Repère segment parent
%L2
centroide_L2CT = M*k_new*[-0.8044241 -111.154867855 787.53803778]'*0.001;%Repère CT-Scan
CoM_L2CT = centroide_L2CT + M*[-0.4 -2.7 0]'*L2_length; %Repère CT-Scan
CoM_L2 = CoM_L2CT - L3_L2CT;%Repère segment parent
L2_L1JointNode = L2_L1CT - L3_L2CT; %Repère segment parent
%L1
centroide_L1CT = M*k_new*[-0.9603 -104.424575345 820.410057905]'*0.001;%Repère CT-Scan
CoM_L1CT = centroide_L1CT + M*[-0.4 -3.5 0]'*L1_length; %Repère CT-Scan
CoM_L1 = CoM_L1CT - L2_L1CT;%Repère segment parent
L1_ThoraxJointNode = L1_ThoraxCT - L2_L1CT; %Repère segment parent
...
L4_position_set = {...
    ...
    'L4POSSUP', M*k_new*[-3.6 -96.22 737.58]'*0.001 - CoM_L4CT;...
    % Muscle path 
...
L3_position_set = {...
    ...
    'L3POSSUP', M*k_new*[-3.6 -100.51 769.43]'*0.001 - CoM_L3CT;...
    % Muscle path 
...
L2_position_set = {...
    ...
    'L2POSSUP', M*k_new*[-3.6 -96.455 798.92]'*0.001 - CoM_L2CT;...
    % Muscle path 
...
L1_position_set = {...
    ...
    'L1POSSUP', M*k_new*[-3.6 -88.905 829.855]'*0.001 - CoM_L1CT;...
    % Muscle path 
...
%% Lower Trunk
    ...
    %OsteoArticularModel(incr_solid).a=[1 0 0]'; %Lateral-Bending
    ...
    %OsteoArticularModel(incr_solid).a=[0 1 0]'; % Axial-rotation
    OsteoArticularModel(incr_solid).a=[0 0 0]';
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    % OsteoArticularModel(incr_solid).limit_sup=   8.67 *(2*pi/360);
    % OsteoArticularModel(incr_solid).limit_inf= -15.33 *(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup=  inf;
    OsteoArticularModel(incr_solid).limit_inf=  -inf;
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    % OsteoArticularModel(incr_solid).limit_sup=   6.51 *(2*pi/360);
    % OsteoArticularModel(incr_solid).limit_inf= -11.49 *(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup=  inf;
    OsteoArticularModel(incr_solid).limit_inf=  -inf;
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf=-1.5*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 1.5*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=1;
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    % OsteoArticularModel(incr_solid).limit_sup=   4.34 *(2*pi/360);
    % OsteoArticularModel(incr_solid).limit_inf=  -7.66 *(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup=  inf;
    OsteoArticularModel(incr_solid).limit_inf=  -inf;
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    % OsteoArticularModel(incr_solid).limit_sup=   3.98 *(2*pi/360);
    % OsteoArticularModel(incr_solid).limit_inf=  -7.02 *(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup=  inf;
    OsteoArticularModel(incr_solid).limit_inf=  -inf;
    ...
    OsteoArticularModel(incr_solid).joint=1;  
    OsteoArticularModel(incr_solid).limit_inf=-1*(2*pi/360);
    OsteoArticularModel(incr_solid).limit_sup= 1*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=1;
    OsteoArticularModel(incr_solid).b=[0 0 0]';
