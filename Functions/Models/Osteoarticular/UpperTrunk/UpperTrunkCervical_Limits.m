function [OsteoArticularModel]= UpperTrunkCervical_Limits(OsteoArticularModel,k,Mass,AttachmentPoint,varargin)
...
%% UpperTrunk
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*(25/4)*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*(15/4)*(2*pi/360);
    ...
    % OsteoArticularModel(incr_solid).limit_inf=-1.5*1.67*(2*pi/360);
    % OsteoArticularModel(incr_solid).limit_sup= 1.5*1.67*(2*pi/360);
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*(45/4)*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*(27/4)*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=0;
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*(55/4)*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*(33/4)*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=0;
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*(25/2)*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*(15/2)*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=0;
...
%
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*(75/8)*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*(45/8)*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=0;
...
%
    ...
    OsteoArticularModel(incr_solid).limit_sup=  1.5*2*(2*pi/360); % From René Louis "Anatomy of the spine"
    OsteoArticularModel(incr_solid).limit_inf=  -1.5*2*(2*pi/360);
    OsteoArticularModel(incr_solid).Visual=0;
